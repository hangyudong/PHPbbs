...
function mout(object){
  ...
  <ul>
    ...
    <li id="m_3" class='m_li' onmouseover='mover(3);' onmouseout='mout(3);'><a href="index.php?m=replay">回复管理</a></li>
...
<font size=4 color="red">回复</font> 
	...
	<?php foreach($data as $val) :?>
			<tr bgcolor="#A698A7" align="center" valign="middle" height="50" >
				<td width="10%"><?=$val['rid'];?></td>
				<td width="10%"><?=$val['aid'];?></td>
				<td width="20%"><?=@date('Y-m-d H:i:s',$val['createtime']);?></td>
				<td height="50"><?=$val['content'];?></td>
				
				
				<td><a href="index.php?m=replay&a=del&rid=<?=$val['rid'];?>">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
