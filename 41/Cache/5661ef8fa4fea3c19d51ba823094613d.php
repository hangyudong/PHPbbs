...
<section class="banner">
	...
	<font size=4 color="red">发表时间</font> 

	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

<font size=4 color="red">标题</font> 
		...
		<?php foreach($articles as $value) :?>
			<tr bgcolor="#A698A7" align="center" valign="middle" height="50" >
				<td width="10%"><?=$value['aid'];?></td>
				<td><?=@date('Y/m/d H:i:s',$value['createtime']);?></td>
				<td><?=$value['title'];?></td>
				
				<td><a href="index.php?m=article&a=del&aid=<?=$value['aid'];?>">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

				删除&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></td>
				<td><a href="index.php?m=article&a=edit&aid=<?=$value['aid'];?>">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				修改
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				</a></td>
