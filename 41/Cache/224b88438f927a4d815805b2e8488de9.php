    ...
    <div class="columns">
        <div class="column three-fourths">
            <article class="article-content markdown-body">
                ...
                <textarea id="append-test" style="display:none;"><?=$data[0]['article'];?></textarea>               
		</div>
...
<br />	
           ...
           <p style="margin-left:100px;">欢迎评论，以上只是个人见解</p>
<br />


<form action="index.php?m=article&a=reply&aid=<?=$data[0]['aid'];?>" method="post">

           <p style="margin-left:100px;"> 回复名 ：<input type="text" name="replyName" style="width:534px;height:50px;" />
            (回复名不能为空，长度在3-10长度)</p>
            <br />
             <script id="editor" type="text/plain" style="width:800px;height:300px;margin-left:100px;"></script>

            
         <pre style="margin-left:824px;">   <input type="submit" value="回复" /></pre>
