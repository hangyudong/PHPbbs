	...
	<div class="container">
        <div class="columns">
            <div class="column three-fourths">
                <div class="collection-title">
                    <h1 class="collection-header"><a href="index.php?m=show&aid=<?=$val['aid'];?>"> 姓名 ：董航宇</a></h1>
                    <div class="collection-info">
                        <span class="meta-info">
  ...
  <p>出生于1994.12.25一个宁静的小村庄，地理位置十分优越
	...
	<div class="container">
        <div class="columns">
            <div class="column three-fourths">
                <div class="collection-title">
                    <h1 class="collection-header"><a href="index.php?m=show&aid=<?=$val['aid'];?>"> 专业技能</a></h1>
                    <div class="collection-info">
                        <span class="meta-info">
                            <span class="octicon octicon-calendar"></span> 
                        </span>
  ...
  <p>熟练html+css
	...
	<div class="container">
        <div class="columns">
            <div class="column three-fourths">
                <div class="collection-title">
                    <h1 class="collection-header"><a href="index.php?m=show&aid=<?=$val['aid'];?>"> 联系方式</a></h1>
                    <div class="collection-info">
                        <span class="meta-info">
                            <span class="octicon octicon-calendar"></span> 
                        </span>
